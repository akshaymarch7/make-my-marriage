...
export function AuthPage({ mode }: { mode: "signup" | "login" }) {
  ...
  return <main className={styles.page}>
    <section className={styles.content}>
      ...
      <div className={styles.inner}><p className={styles.eyebrow}>A beautiful beginning</p><h1>{signup ? "Your forever,\nstarts here." : "Welcome back\nto your big day."}</h1><p className={styles.subtitle}>{signup ? "Create your account and take the first step towards a celebration that’s truly yours." : "Sign in to your Make My Marriage account. We’re happy to see you again."}</p><AuthForm mode={mode}/></div>
